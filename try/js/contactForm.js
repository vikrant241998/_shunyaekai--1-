...
Description.onkeyup = function () {
  ...
  if (
    ...
    errorMessage[6].innerHTML = "please enter valid description";
    contactObj.descriptionErr = false;
  } else {
    errorMessage[6].innerHTML = "Description must be atleast 20 characters";
    contactObj.descriptionErr = false;
  }
};
// address
function contactFormSubmit(event) {
  ...
  if (Object.values(contactObj).every((value) => value === true)) {
    ...
    if (contactObj.descriptionErr === false) {
      errorMessage[6].innerHTML = "Please fill in this field";
    }
  }
}
